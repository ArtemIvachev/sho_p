    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span9">
                ...
                <h3 style="color: white">  КОРЗИНА ПОКУПАТЕЛЯ ( <small><?php echo Cart::countItems();?> Товар(ы) </small>)<a href="/catalog/category-1/" class="btn btn-large pull-right"><i class="icon-arrow-left"></i>Продолжить покупку</a></h3>
                <hr class="soft"/>
                        ...
                        <tbody>
                            <?php foreach ($products as $product): ?>
                                <tr>
                                    ...
                                    <td style="color: white; font-size: 20px; text-align: center; font-weight: bold"><br/>Игрушка</td>
                                    <td>
