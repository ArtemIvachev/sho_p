    ...
    <div class="container">
        <div class="row">
            ...
            <div class="span9">
                ...
                <h3 style="color: white; font-weight: bold">  КОРЗИНА ПОКУПАТЕЛЯ [ <small><?php echo Cart::countItems();?> Товар(ы) </small>]</h3>
                <hr class="soft"/>
                        ...
                        <tr>
                            <td>
                                <form class="form-horizontal" action="" method="post">
                                    ...
                                    <div class="control-group">
                                        <div class="controls">
                                            <button type="submit" name="submit" class="btn" style="color: white; font-weight: bold">ОТПРАВЛЕНО</button>
                                        </div>
                                    </div>
                                </form>				  
                            </td>
