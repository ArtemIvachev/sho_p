                ...
                <div class="row">	  
                    ...
                    <div class="span6">
                        ...
                        <p style="color: white; font-weight: bold; font-size: 20px">
                            Высота этой необыкновенной модели в масштабе 1:8 составляет более 13 см, длина — более 60 см, а ширина — более 25 см.
                            У нее есть декоративная табличка с данными и уникальный серийный номер, открывающий доступ к эксклюзивным материалам в сети.
                            Модель продается в особой коробке, и с ней вы найдете две стильные книги с инструкциями по сборке, фотографиями и интервью с создателями модели.
                        </p>
                            ...
                            <div class="tab-pane fade active in" id="home">
                                ...
                                <table class="table table-bordered" style="background-color: currentColor">
                                    <tbody>
                                        ...
                                        <tr class="techSpecRow"><td class="techSpecTD1" style="color: white; font-weight: bold; font-size: 20px">Бренд: </td><td class="techSpecTD2" style="color: white; font-weight: bold; font-size: 20px">LEGO</td></tr>
                                        <tr class="techSpecRow"><td class="techSpecTD1" style="color: white; font-weight: bold; font-size: 20px">Модель:</td><td class="techSpecTD2" style="color: white; font-weight: bold; font-size: 20px">Technic FKP 37</td></tr>
                                        <tr class="techSpecRow"><td class="techSpecTD1" style="color: white; font-weight: bold; font-size: 20px">Выпущена:</td><td class="techSpecTD2" style="color: white; font-weight: bold; font-size: 20px"> 2019-01-28</td></tr>
                                        <tr class="techSpecRow"><td class="techSpecTD1" style="color: white; font-weight: bold; font-size: 20px">Делатей:</td><td class="techSpecTD2" style="color: white; font-weight: bold; font-size: 20px"> 5000</td></tr>
                                    </tbody>
                                </table>
